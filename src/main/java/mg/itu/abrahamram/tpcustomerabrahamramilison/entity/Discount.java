 ...
 */
package mg.itu.abrahamram.tpcustomerabrahamramilison.entity;
...
/**
 * Classe Entity representant DISCOUNT
 * @author Aldramech
 */
@Entity
@Table(name = "discount")
...
public class Discount implements Serializable {
    ...
    public String toString() {
        return "mg.itu.abrahamram.tpcustomerabrahamramilison.entity.Discount[ code=" + code + " ]";
    }
